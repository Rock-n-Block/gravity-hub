  ...
  section.block.block-reaching
    div.container-content
      div.container-content-wrap
        ...
        div.block-image
          img.block-image-wrap(src='img/Reaching_consensus_illustration.svg', alt='watching data')
...
.block {
  &-reaching {
    // background: url("~static/img/rm_03.png") no-repeat left center/contain;
    ...
    .container-content {
      ...
      &-wrap {
        // grid-template-columns: minmax(300px, 390px) minmax(300px, 850px);
        grid-template-columns: minmax(300px, 360px) minmax(300px, 790px);
        max-width: 1250px;
        width: 100%;
        display: grid;
        z-index: 2;
